  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-10 text-slate-700">
      ...
      >
        ...
        <button
          className="bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white flex gap-3 w-full justify-center rounded-xl items-center 
      ...
      {/*Right Col*/}
      <div className="w-full max-w-lg p-4 bg-white flex flex-col border border-gray-200 min-h-96 max-h-600">
        <div className="flex items-center gap-3">
