    ...
    <div className="flex flex-col items-center text-center mb-20">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
          ...
          <p>
            Igris.ai has completely changed how I edit images. The background removal is fast, accurate, and saves me hours every week.
          </p>
        ...
        <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
          ...
          <p>
            The AI tools are incredibly easy to use. Object removal works like magic and helps me create better visuals for my blogs.
          </p>
          <p className="text-lg text-gray-800 font-medium mt-5">
            Richard Nelson
          </p>
        ...
        <div className="flex flex-col items-center bg-white px-3 py-8 rounded-lg border border-gray-300/80 max-w-[272px] text-sm text-center text-gray-500">
          ...
          <p>
            Clean interface and powerful AI features. I use it daily for client projects and presentations.
          </p>
          <p className="text-lg text-gray-800 font-medium mt-5">
            James Washington
          </p>
